---
title: "Evaluating RSV older adult vaccination programmes for UKHSA in 2024/25"
author: "David Hodgson"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Evaluating RSV older adult vaccination programmes for UKHSA in 2024/25}
...
econ_raw_ls <- read.csv(file = system.file(package = "rsvie", "extdata", "econ", "econ_pars_ls.csv")) 
...
outcomes_incidence_low_mort <- read.csv(file = system.file(package = "rsvie", "extdata", "econ", "2425", "outcomes_incidence_low_mort.csv")) # high mortality estimates 
outcomes_incidence_mid_mort <- read.csv(file = system.file(package = "rsvie", "extdata", "econ", "2425", "outcomes_incidence_mid_mort.csv")) # high mortality estimates 
outcomes_incidence_high_mort <- read.csv(file = system.file(package = "rsvie", "extdata", "econ", "2425", "outcomes_incidence_high_mort.csv")) # high mortality estimates 
...
get_posterior_of_multiseason_fit <- function() {
    ...
    save(out1, file = here::here("outputs", "oa_2425", "fitted_eff.RData"))

    posterior <- getSample(out1)

}

posterior <- get_posterior_of_multiseason_fit()
...
require(patchwork)
p1 / p2
ggsave(here::here("outputs", "oa_2425", "figs", "waning.png"))
...
immune_profiles <- readRDS(file = system.file(package = "rsvie", "extdata", "efficacies", "immune_profiles_unbound.RDS"))
...
cal_lav_2425 <- read.csv(file = system.file(package = "rsvie", "extdata", "calendars", "2425", "cal_oa_2425.csv")) 
...
save(RSV_lav_pal_lm, file = here::here("outputs", "oa_2425", "RSV_oa_pal_lm.RData"))
save(RSV_lav_2425_lm, file = here::here("outputs", "oa_2425", "RSV_oa_2425_lm.RData"))

save(RSV_lav_pal_mm, file = here::here("outputs", "oa_2425", "RSV_oa_pal_mm.RData"))
save(RSV_lav_2425_mm, file = here::here("outputs", "oa_2425", "RSV_oa_2425_mm.RData"))

save(RSV_lav_pal_hm, file = here::here("outputs", "oa_2425", "RSV_oa_pal_hm.RData"))
save(RSV_lav_2425_hm, file = here::here("outputs", "oa_2425", "RSV_oa_2425_hm.RData"))
...
ggsave(here::here("outputs", "oa_2425", "figs", "uptake.png"))
