...
cal_lav_65 <- read.csv(file = system.file(package = "rsvie", "extdata", "calendars", "cal_lav_65.csv")) 

RSV_65_vhr <- add_programme(RSVempty, prog_name = "pal", cal_none, cal_vhr_s, immune_profile$mat_vhr)
RSV_65_s <- add_programme(RSVempty, prog_name = "mab_s", cal_lav_65, cal_vhr_s, immune_profile$lav)
