...
efficacy_t <- load(file = system.file(package = "rsvie", "extdata", "efficacies", "nmab_post_wane.RData")) 
...
RSV_mab_s <- run(RSV_mab_s)
RSV_mab_s_cu <- run(RSV_mab_s_cu)
RSV_mab_yr <- run(RSV_mab_yr)
