...
RSV_mat_vhr <- add_programme(RSVempty, prog_name = "pal", cal_none, cal_vhr_s, immune_profile$mat_vhr)
RSV_mat_s <- add_programme(RSVempty, prog_name = "mab_s", cal_lav_65, cal_vhr_s, immune_profile$mat)
...
RSV_mat_s_sum <- summarise_outcomes(RSV_mab_t)
